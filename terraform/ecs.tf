...
resource "aws_ecs_task_definition" "api" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "GOOGLE_CALLBACK_URL", value = "http://${aws_alb.main.dns_name}/oauth/callback/google" },
      ...
      { name = "AZURE_CALLBACK_URL", value = "http://${aws_alb.main.dns_name}/oauth/callback/azure" },
      { name = "GITHUB_CLIENT_ID", value = "dummy-github-client-id" },
      { name = "GITHUB_CLIENT_SECRET", value = "dummy-github-client-secret" },
      { name = "GITHUB_CALLBACK_URL", value = "http://${aws_alb.main.dns_name}/oauth/callback/github" },
